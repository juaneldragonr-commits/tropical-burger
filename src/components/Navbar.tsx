...
const Navbar = ({ onScrollToMenu }: NavbarProps) => {
  ...
  // Lógica inteligente: Si hay items, abre el carrito. Si no, va al menú.
    ...
    <nav className="fixed top-0 left-0 w-full z-50 bg-white/80 backdrop-blur-md border-b border-gray-100/50 transition-all duration-300">
      <div className="flex justify-between items-center py-4 px-6 md:px-12 max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-6">
          {/* Botón de Menú con scroll suave */}
          <button 
          ...
          <div className="relative">
            <button 
              ...
              className="flex items-center gap-2 bg-burger-brown text-white px-4 py-2 rounded-full hover:bg-orange-700 transition-all active:scale-95"
            >
